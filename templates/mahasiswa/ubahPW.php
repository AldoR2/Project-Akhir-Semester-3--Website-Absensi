...
<body>
    ...
    <section class="content container">
        ...
        <div class="table-responsive ubahPassword">
            <form class="form-password" action="confirm_pass.php" method="POST">
                <div class="form-group-password">
                    <label for="password">Password Lama :</label>
                    <input type="password" id="password" name="password_lama" placeholder="Enter your password" required>
                </div>
